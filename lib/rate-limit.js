 ...
 * Reminders are the same case: no AI quota, their own per-caller limits and
 * their own daily cap in api/reminders.js.
 */
const OFF_INSTANCE_BUDGET = new Set(["restPush", "reminders"]);
