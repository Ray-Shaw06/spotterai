...
// Gemini 2.0 Flash was shut down on June 1, 2026. Keep the fallback on a
// current model that supports both image input and structured JSON output so
// meal-photo requests can recover when the primary model is rate-limited.
