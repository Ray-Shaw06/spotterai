...
> **1013 tests, 23 adversarial eval cases, 3 runtime dependencies, no build step.**
...
| **Tests** | **1013 tests**, holding **line coverage above 85%** ([live figure](https://codecov.io/gh/Ray-Shaw06/spotterai)), on Node's built-in runner. | `npm test` |
