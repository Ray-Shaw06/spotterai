...
**Web browsing: always use the `/browse` skill from gstack.** Never use the
`mcp__claude-in-chrome__*` tools. If a task needs a browser for any reason
(QA, dogfooding, reading a page, checking a deploy), reach for `/browse`.
